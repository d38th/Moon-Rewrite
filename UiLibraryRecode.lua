...
function Library:CreateWindow(windowname,windowinfo)
    ...
    Frame.BorderColor3 = Color3.fromRGB(25, 30, 35)
    Frame.BorderSizePixel = 0
    Frame.Position = UDim2.new(0.5, 0, 0.5, 0)
    Frame.Size = UDim2.new(0.409, 0, 0.482, 0)
    ...
    DashBoard.BackgroundColor3 = Color3.fromRGB(20, 25, 30)
    DashBoard.BorderColor3 = Color3.fromRGB(20, 25, 30)
    DashBoard.Position = UDim2.new(0.019, 0, 0.038, 29)
    DashBoard.Size = UDim2.new(0, 619, 0, 61)
    ...
    PageContainer.BackgroundColor3 = Color3.fromRGB(20, 25, 30)
    PageContainer.BorderColor3 = Color3.fromRGB(20, 25, 30)
    PageContainer.Position = UDim2.new(0.019, 0, 0.168, 50)
    PageContainer.Size = UDim2.new(0, 619, 0, 255)
    ...
    Title.Position = UDim2.new(-0.006, 21, 0.052, -10)
    Title.Size = UDim2.new(0, 355, 0, 24)
